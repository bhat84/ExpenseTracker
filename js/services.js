...
if(provider == "amazon") {			
	...
	/**
	 * return the access key provided by amazon
	 */ 
	...
	/**
	 * return the id provided by amazon
	 */  
...
.factory('dynamoNg', function (configAWS, loggerManager) {
	...
	baseFactory.build = function() {
		...
		baseFactory.handler =  new AWS.DynamoDB({TableName: 'finance6',region: 'us-east-1', accessKeyId: 'AAAAAA', secretAccessKey: 'BBBBBBB'});
